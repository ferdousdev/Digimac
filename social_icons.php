...
<?php
	$et_youtube_url = '' !== et_get_option( 'divi_youtube_url' )
		? et_get_option( 'divi_youtube_url' )
		: get_bloginfo( 'youtube_url' );
?>
	<li class="et-social-icon et-social-youtube">
		<a href="https://youtube.com/digimac/" class="icon">
...
<a href="https://www.linkedin.com/digimac/" class="icon">
<span><?php esc_html_e( 'Linkdin', 'Divi' ); ?></span>
</a>
</li>
